    ...
    return (
        <section id='about' className='min-h-screen overflow-hidden flex items-center justify-center text-white px-4 sm:px-6'>
            <div className='max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8  sm:gap-12 items-center'>
                ...
                <article className='text-center lg:text-left relative' data-aos='fade-left' data-aos-delay='500'>
                    <div className='absolute z-0 w-40 sm:w-60 sm:h-60 bg[#cd3cf5] rounded-full blur-3xl opacity-50 
                    -top-5 left-10'></div>
                    <header>
                    ...
                    <p className='text-base sm:text-lg md:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed'>
                        je suis un développeur passionné par la création d'expériences web innovantes et intuitives. Avec une solide formation en développement front-end et back-end, je m'efforce de concevoir des applications performantes et esthétiques. Mon objectif est de transformer les idées en réalité numérique tout en assurant une expérience utilisateur optimale.
                    </p>
                    <footer>
